...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    private static final String DATABASE_NAME = "FillUpDB.db";
    ...
    private FillUpDAO FillUpDAO = null;
    ...
    //синглтон для FillUpDAO
    public FillUpDAO getFillUpDAO() {
        if (FillUpDAO == null) {
            try {
                FillUpDAO = new FillUpDAO(getConnectionSource(), FillUp.class);
